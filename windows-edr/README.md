...
![Échecs de connexion](../screenshots/failed-logon.png)

## Création d’utilisateur
La création d’un utilisateur est surveillée.

![Création utilisateur](../screenshots/user-created.png)
...
![Statistiques Windows](../screenshots/windows-security-stats.png)
