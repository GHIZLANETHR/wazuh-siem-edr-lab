...
![Tentatives SSH échouées](../screenshots/ssh-failed.png)

## Alertes d’authentification
Les alertes “authentication failed” sont générées.

![Alertes SSH](../screenshots/ssh-alerts.png)
...
![Modification /etc/passwd](../screenshots/fim-passwd.png)

## Statistiques
Vue globale des événements de sécurité Linux.

![Statistiques Linux](../screenshots/linux-security-stats.png)
